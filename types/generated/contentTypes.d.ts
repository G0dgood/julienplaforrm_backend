...
export interface ApiBuyObjectiveBuyObjective
  ...
  info: {
    displayName: 'Buy objective';
    pluralName: 'buy-objectives';
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::buy-objective.buy-objective'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    text: Schema.Attribute.String;
...
export interface ApiBuyTypeBuyType extends Struct.CollectionTypeSchema {
  collectionName: 'buy_types';
  info: {
    displayName: 'Buy type';
    pluralName: 'buy-types';
...
>>>>>>> cbdd26303b1138f1de37c4a7a5b20babf425d4a1
...
export interface ApiPlatformListPlatformList
  extends Struct.CollectionTypeSchema {
...
export interface ApiPurchaseOrderPurchaseOrder
  ...
  attributes: {
    assigned_media_plans: Schema.Attribute.Component<
      'campaign.media-p-lans',
      true
    >;
    client: Schema.Attribute.Relation<'manyToOne', 'api::client.client'>;
    client_responsible: Schema.Attribute.Relation<
      'manyToOne',
      'plugin::users-permissions.user'
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    financial_responsible: Schema.Attribute.Relation<
      'manyToOne',
      'plugin::users-permissions.user'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
